...
// Pg 431, to start implementing the bidding component, we will intergrate sockets using Socket.IO client side librabry
...
// Pg 433, adding a form to enter a bid
export default function Bidding (props) {
    ...
    // Pg 436, Updating the view state with a new bid
    useEffect(() => {
    ...
    // Pg 434, construct a bid object containing the new bid's details, including the bid amount, bid time, and the bidder's user refrence
    const placeBid = () => {
        let newBid = {
            bid: bid,
            time: new Date(),
    ...
    // Pg 433, Form to handle bid
    // Pg 437, Rendering the bidding history
    return(
        <div>
