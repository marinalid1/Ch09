...
// Pg 427, justEnded value is passed to the Bidding component so that it can be user to disable the option to place bids when the time ends.
export default function Auction ({match}) {
  ...
  // Pg 427, Adding the timer component
  // Pg 431, intergrate Socket.IO in the Bidding component that we add to the Auction compoent in the frontend
    return (
